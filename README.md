...
* [Polygon’s Zero Knowledge Odyssey Part I](https://medium.com/@sanilshah1999/polygons-zero-knowledge-odyssey-part-1-6-3abb67cb5da8), [Part II](https://medium.com/@sanilshah1999/polygons-zero-knowledge-odyssey-part-2-89ad9f6533f0), [Part III](https://medium.com/@sanilshah1999/polygons-zero-knowledge-odyssey-part-3-cfb9c8d81cf1), [Part IV](), [Part V](), [Part VI]() - 2 parts of 6-part series of articles from February 2023. They take a closer look at some of the key acquisitions and developments that have helped shape the future of Polygon using the power of Zero Knowledge (ZK).
...
* [https://thebojda.medium.com/an-introduction-of-zk-merkle-tree-a-javascript-library-for-anonymous-voting-on-ethereum-using-79caa3415d1e](https://thebojda.medium.com/an-introduction-of-zk-merkle-tree-a-javascript-library-for-anonymous-voting-on-ethereum-using-79caa3415d1e) - article about zk-merkle-tree library by Laszlo Fazekas from January 2023.
* [WASM: Making Web3 Development Accessible to All](https://medium.com/@0xwasm/wasm-making-web3-development-accessible-to-all-7319f35b73f9)) - article by ZKWasm from February 2023.
...
* [WASM emulator](https://github.com/DelphinusLab/zkWasm) - crucial part which served as a trustless trustless adopter between rich applilcation running on WASM runtime and smart contracts on various blockchains.
...
* [EthSnarks](https://github.com/HarryR/ethsnarks) - collection of zkSNARK circuits and supporting libraries to use them with Ethereum smart contracts.
...
* [Lecture 10.3: What is a zk-SNARK?](https://www.youtube.com/watch?v=gcKCW7CNu_M) - Part of a larger lecture. Simple, but the in-depth explanation of zk-SNARK with some mathematic notation, but explained as it goes.
* [Lecture 2: Overview of Modern SNARK Constructions](https://www.youtube.com/watch?v=MUnlR3gMKu0&list=PLS01nW3Rtgoo_0Y-X5bQ32SyDbMiGFqee) - lecture about the math behind the SNARK and examples by Dan Boneh.
...
* [Learning about Zero Knowledge Proof](https://open.spotify.com/episode/3gS1Axn2MAxXFEgRu8QcZz?si=d54d51234e6c4377) - episode from The Bad Crypto podcast from January 2023.
