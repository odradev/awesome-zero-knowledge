...
* [Arbitrum Nova](https://nova.arbitrum.io/) - Arbitrum Nova  is a suite of Ethereum scaling solutions thtat enables high-throughput, low cost smart contracts while remaining trustlessly secure.
...
* [Bilinear Pairings-based Zero-Knowledge Proofs - Jens Groth, DFINITY](https://www.youtube.com/watch?v=X-z3JYlFdzs) - Jens Groth, member of the ZKProof Steering Committee, presented the framework of bilinear pairings for constructing zero-knowledge proofs at Dfinity conference. 
...
* [ZK Study Club - Plonk with Zac Williamson](https://www.youtube.com/watch?v=NqrVcDuQ8hM) - lecture given by Zac Williamson - founder of Aztec - about math behind Plonk.
